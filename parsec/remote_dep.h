...
#define PARSEC_ACTION_DEPS_MASK                  0x00FFFFFFFFFFFFFF
#define PARSEC_ACTION_RELEASE_LOCAL_DEPS         0x0100000000000000
#define PARSEC_ACTION_RELEASE_LOCAL_REFS         0x0200000000000000
#define PARSEC_ACTION_GET_REPO_ENTRY             0x0400000000000000
#define PARSEC_ACTION_RESHAPE_ON_RELEASE         0x0800000000000000
#define PARSEC_ACTION_SEND_INIT_REMOTE_DEPS      0x1000000000000000
#define PARSEC_ACTION_SEND_REMOTE_DEPS           0x2000000000000000
#define PARSEC_ACTION_RECV_INIT_REMOTE_DEPS      0x4000000000000000
#define PARSEC_ACTION_RESHAPE_REMOTE_ON_RELEASE  0x8000000000000000
